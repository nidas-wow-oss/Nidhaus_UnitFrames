...
-- justamente trae la version Light de esta misma UI. Un solo dueÃ±o por
-- marco.
-- =========================================================
...
-- ---------------------------------------------------------
-- Sub-opciones en la pestaÃ±a Modules, con la misma forma que Lorti
-- ---------------------------------------------------------
...
SlashCmdList["NUFWHAT"] = function()
	print("|cff00FF00Nidhaus|r  llevÃ¡ el mouse al recuadro. Leo en 3 segundos.");
	whatAcc = 0;
	whatTimer:Show();
end
