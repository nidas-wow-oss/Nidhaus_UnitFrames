...
L["PCB_CB_BLIZZ_STYLE"]          = "Blizzard style (same as arena)";
...
L["BTN_BORDER_CAST"]             = "Casting bar border";
L["BTN_BORDER_TOOLTIP"]          = "Tooltip border";
...
L["PCB_CB_BLIZZ_STYLE"]          = "Estilo Blizzard (igual que la de arena)";
...
L["BTN_BORDER_CAST"]             = "Borde de barra de casteo";
L["BTN_BORDER_TOOLTIP"]          = "Borde de tooltip";
