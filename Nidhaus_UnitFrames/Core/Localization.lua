...
L["CB_POWERBAR_COMBAT"]          = "Only in combat";
L["CB_POWERBAR_PCT"]             = "Percentage, not numbers";
L["TIP_PowerBarPct"]             = "Shows 73% instead of 7300 / 10000 on both bars.";
L["CB_POWERBAR_HEALTH"]          = "Also a health bar";
L["CB_POWERBAR_GRADIENT"]        = "Color by health left";
...
L["CB_POWERBAR_HIDEFULL"]        = "Hide it when full";
L["CB_POWERBAR_CLASSCOLOR"]      = "Health in class color";
L["CB_POWERBAR_HIDETEXT"]        = "Hide the numbers";
L["TIP_PowerBarHideText"]        = "Turns the numbers off entirely. The bar alone already tells you how much is left.";
L["CB_ARENA_BLIZZ_CLASSCOLOR"]   = "Class color";
L["CB_POWERBAR_AURAS"]           = "Buffs and debuffs";
L["TIP_PowerBarClassColor"]      = "Paints the health bar with your class color instead of green. It wins over the gradient above.";
L["TIP_PowerBarAuras"]           = "Two rows of small icons: buffs on top, debuffs below. Unlike the Blizzard frame it shows all of them, not a chosen few.";
L["BTN_AURAPOS_LABEL"]           = "Auras:";
L["AURAPOS_RIGHT"]               = "Right";
L["AURAPOS_BOTTOM"]              = "Below";
L["AURAPOS_TOP"]                 = "Above";
...
L["SW_LOCK"]                     = "Lock the bar";
L["SW_LOCK_TIP"]                 = "While unlocked you can drag the bar with the left mouse button. Right-click opens its menu.";
L["SW_FLASH"]                    = "Flash the border on warning";
L["SW_WARN_TIME"]                = "Warn when little time is left";
L["SW_WARN_TIME_VALUE"]          = "Seconds left";
L["SW_WARN_PCT"]                 = "Warn when the shield runs low";
L["SW_WARN_PCT_VALUE"]           = "Remaining %";
L["SW_SCALE"]                    = "Bar scale";
...
L["SLIDER_POWERBAR_AURASIZE"]    = "Aura icon size";
L["SLIDER_POWERBAR_AURAROW"]     = "Auras per row";
...
L["TAB_ADDONS"]                  = "Addons";
L["TAB_PVP"]                     = "PvP";
L["TAB_PROFILES"]                = "Profiles / MySlot";
...
L["PCB_STYLE_LABEL"]             = "Bar style: %s";
L["PCB_STYLE_TITLE"]             = "Bar style:";
L["PCB_STYLE_ARCANE"]            = "Arcane";
L["PCB_STYLE_BLIZZ"]             = "Blizzard";
L["PCB_STYLE_ARENA"]             = "Arena";
...
L["SLOT_NOTE_CLASS"]             = "Only characters of your class. Other WoW accounts: use Export / Import.";
L["SLOT_NOTE_HIDDEN"]            = "hidden";
...
L["BTN_BORDER_LABEL"]            = "Border:";
L["BORDER_TOOLTIP"]              = "Tooltip";
L["BORDER_NONE"]                 = "No border";
...
L["CB_POWERBAR_COMBAT"]          = "Solo en combate";
L["CB_POWERBAR_PCT"]             = "Porcentaje, no numeros";
L["TIP_PowerBarPct"]             = "Muestra 73% en vez de 7300 / 10000 en las dos barras.";
L["CB_POWERBAR_HEALTH"]          = "Tambien barra de vida";
L["CB_POWERBAR_GRADIENT"]        = "Color segun la vida";
...
L["CB_POWERBAR_HIDEFULL"]        = "Ocultarla a full";
L["CB_POWERBAR_CLASSCOLOR"]      = "Vida en color de clase";
L["CB_POWERBAR_HIDETEXT"]        = "Ocultar los numeros";
L["TIP_PowerBarHideText"]        = "Apaga los numeros del todo. La barra sola ya dice cuanto queda.";
L["CB_ARENA_BLIZZ_CLASSCOLOR"]   = "Color de clase";
L["CB_POWERBAR_AURAS"]           = "Buffs y debuffs";
L["TIP_PowerBarClassColor"]      = "Pinta la barra de vida con el color de tu clase en vez de verde. Manda por encima del degradado de arriba.";
L["TIP_PowerBarAuras"]           = "Dos filas de iconos chicos: arriba los buffs, abajo los debuffs. A diferencia del marco de Blizzard los muestra todos, no unos pocos elegidos.";
L["BTN_AURAPOS_LABEL"]           = "Auras:";
L["AURAPOS_RIGHT"]               = "Derecha";
L["AURAPOS_BOTTOM"]              = "Abajo";
L["AURAPOS_TOP"]                 = "Arriba";
...
L["SW_LOCK"]                     = "Bloquear la barra";
L["SW_LOCK_TIP"]                 = "Desbloqueada se arrastra con el boton izquierdo. El derecho abre su menu.";
L["SW_FLASH"]                    = "Destello del borde al avisar";
L["SW_WARN_TIME"]                = "Avisar cuando queda poco tiempo";
L["SW_WARN_TIME_VALUE"]          = "Segundos restantes";
L["SW_WARN_PCT"]                 = "Avisar cuando queda poco escudo";
L["SW_WARN_PCT_VALUE"]           = "Escudo restante %";
L["SW_SCALE"]                    = "Escala de la barra";
...
L["SLIDER_POWERBAR_AURASIZE"]    = "Tamano del icono";
L["SLIDER_POWERBAR_AURAROW"]     = "Auras por fila";
...
L["TAB_ADDONS"]                  = "Addons";
L["TAB_PVP"]                     = "PvP";
L["TAB_PROFILES"]                = "Perfiles / MySlot";
...
L["PCB_STYLE_LABEL"]             = "Estilo de barra: %s";
L["PCB_STYLE_TITLE"]             = "Estilo de barra:";
L["PCB_STYLE_ARCANE"]            = "Arcano";
L["PCB_STYLE_BLIZZ"]             = "Blizzard";
L["PCB_STYLE_ARENA"]             = "Arena";
...
L["BTN_ARENA_TEST_CLEAR"]        = "Limpiar";
...
L["SLOT_NOTE_CLASS"]             = "Solo personajes de tu clase. Otras cuentas de WoW: usa Exportar / Importar.";
L["SLOT_NOTE_HIDDEN"]            = "ocultos";
...
L["BTN_BORDER_LABEL"]            = "Borde:";
L["BORDER_TOOLTIP"]              = "Tooltip";
L["BORDER_NONE"]                 = "Sin borde";
L["BORDER_BLIZZARD"]             = "Blizzard";
