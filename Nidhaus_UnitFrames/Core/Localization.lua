...
L["CB_POWERBAR_CLASSCOLOR"]      = "Health bar in your class color";
L["CB_POWERBAR_HIDETEXT"]        = "Hide the numbers on both bars";
...
L["CB_POWERBAR_AURAS"]           = "Show your buffs and debuffs";
...
L["CB_POWERBAR_CLASSCOLOR"]      = "Barra de vida con el color de tu clase";
L["CB_POWERBAR_HIDETEXT"]        = "Ocultar los numeros de las dos barras";
...
L["CB_POWERBAR_AURAS"]           = "Mostrar tus buffs y debuffs";
